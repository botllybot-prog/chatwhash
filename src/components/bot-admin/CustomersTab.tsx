...
const texts = {
  ar: { title: "????? ?????", bulk: "????? ????? ??????", total: "?????? ???????", whatsapp: "??????", telegram: "??????", withBookings: "????? ??????", search: "??? ??????? ?? ?????...", all: "????", noCustomers: "?? ???? ????? ???", name: "?????", phone: "??????", platform: "??????", bookings: "????????", lastActivity: "??? ????", status: "??????", actions: "???????", blocked: "?????", active: "???", sendMessage: "????? ?????", unblock: "????? ?????", block: "???", singleTitle: "????? ????? ???", bulkTitle: "????? ????? ??????", text: "?? ???????", send: "?????", sending: "???? ???????...", sentSuccess: "?? ????? ??????? ????? ?", sentFail: "??? ????? ???????", blockDone: "?? ??? ??????", unblockDone: "?? ????? ?????", genericError: "??? ???", customersCount: "????", noName: "—", messageHere: "???? ?????? ???...", offerHere: "???? ?????? / ???? ???...", sendTo: "???? ??????? ???", only: "???", sentSummary: "?? ???????", successWord: "???", failWord: "???", phoneLabel: "??????", platformLabel: "??????", unknownDate: "—" },
  ...
  ku: { title: "???????? ???", bulk: "?????? ?????? ????", total: "??? ???????", whatsapp: "??????", telegram: "????????", withBookings: "?????? ????", search: "?? ????? ??? ??? ?????...", all: "?????", noCustomers: "????? ??? ??????? ????", name: "???", phone: "???????", platform: "????????", bookings: "???????", lastActivity: "??? ??????", status: "???", actions: "?????????", blocked: "????????", active: "?????", sendMessage: "?????? ?????", unblock: "???????? ????????", block: "????????", singleTitle: "?????? ????? ??", bulkTitle: "?????? ?????? ????", text: "???? ?????", send: "?????", sending: "????? ?? ???????...", sentSuccess: "???????? ?? ??????????? ?????? ?", sentFail: "?????? ????? ????????? ?????", blockDone: "???????? ???????", unblockDone: "???????? ???????", genericError: "??????? ??????", customersCount: "?????", noName: "—", messageHere: "????????? ???? ??????...", offerHere: "????? ??? ????????? ???? ??????...", sendTo: "????????? ??", only: "?????", sentSummary: "??????", successWord: "?????????", failWord: "????", phoneLabel: "?????", platformLabel: "????????", unknownDate: "—" },
  tr: { title: "Bot müsterileri", bulk: "Toplu mesaj gönder", total: "Toplam müsteri", whatsapp: "WhatsApp", telegram: "Telegram", withBookings: "Rezervasyonlu", search: "Telefon veya ada göre ara...", all: "Tümü", noCustomers: "Henüz müsteri yok", name: "Ad", phone: "Telefon", platform: "Platform", bookings: "Rezervasyonlar", lastActivity: "Son etkinlik", status: "Durum", actions: "Islemler", blocked: "Engelli", active: "Aktif", sendMessage: "Mesaj gönder", unblock: "Engeli kaldir", block: "Engelle", singleTitle: "Mesaj gönder:", bulkTitle: "Toplu mesaj gönder", text: "Mesaj metni", send: "Gönder", sending: "Gönderiliyor...", sentSuccess: "Mesaj basariyla gönderildi ?", sentFail: "Mesaj gönderilemedi", blockDone: "Müsteri engellendi", unblockDone: "Müsteri engeli kaldirildi", genericError: "Bir hata olustu", customersCount: "müsteri", noName: "—", messageHere: "Mesajinizi buraya yazin...", offerHere: "Mesajinizi / teklifinizi buraya yazin...", sendTo: "Suraya gönderilecek", only: "yalnizca", sentSummary: "Gönderildi", successWord: "basarili", failWord: "basarisiz", phoneLabel: "Telefon", platformLabel: "Platform", unknownDate: "—" },
} as const;
