...
export const adminOffersTexts: Record<AppLanguage, OfferTextBundle> = {
  ar: {
    ...
    offers: {
      ...
      mediaStorageBody:
        "تعذّر تخزين وسائط العرض، لذلك لم يتم تطبيق أي تغييرات. تحقّق من الاتصال ثم أعد المحاولة.",
      moveUp: "تحريك للأعلى",
  ...
  en: {
    ...
    offers: {
      ...
      mediaStorageTitle: "Media could not be saved",
      mediaStorageBody:
        "The offer media could not be stored, so no changes were applied. Check your connection and try again.",
      moveUp: "Move up",
      moveDown: "Move down",
  ...
  ku: {
    ...
    offers: {
      ...
      mediaStorageTitle: "پاشەکەوتکردنی فایل سەرکەوتوو نەبوو",
      mediaStorageBody:
        "میدیای پێشکەش پاشەکەوت نەکرا، بۆیە هیچ گۆڕانکارییەک جێبەجێ نەکرا. پەیوەندی بپشکنە و دووبارە هەوڵ بدە.",
      moveUp: "بردنە سەرەوە",
  ...
  tr: {
    ...
    offers: {
      ...
      mediaStorageTitle: "Dosya kaydedilemedi",
      mediaStorageBody:
        "Kampanya medyası saklanamadı, bu nedenle hiçbir değişiklik uygulanmadı. Bağlantınızı kontrol edip yeniden deneyin.",
      moveUp: "Yukarı taşı",
      moveDown: "Aşağı taşı",
