...
Deno.serve(async (req) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ success: true, bookings: data || [] }), { status: 200, headers: { ...corsHeaders, "Content-Type": "application/json" } });
  } catch (error) {
