...
const styles = StyleSheet.create({
  ...
  profileCard: { flexDirection: "row-reverse", gap: 12, backgroundColor: palette.white, borderColor: palette.line, borderWidth: 1, borderRadius: 18, padding: 12, marginBottom: 12 },
  imageBox: { width: 116, height: 116, borderRadius: 14, backgroundColor: "#eaf3fb", overflow: "hidden", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: palette.line },
  stationImage: { width: "100%", height: "100%" },
  imagePlaceholder: { color: palette.deepBlue, fontWeight: "900", textAlign: "center" },
  profileInfo: { flex: 1 },
  stationName: { textAlign: "right", color: palette.deepBlue, fontSize: 24, fontWeight: "900" },
  stationMeta: { textAlign: "right", color: palette.muted, marginTop: 4, lineHeight: 19 },
  profileActions: { flexDirection: "row-reverse", gap: 8, marginTop: 10 },
  smallLightBtn: { flex: 1, borderRadius: 10, backgroundColor: "#eaf3fb", alignItems: "center", paddingVertical: 9 },
  smallLightText: { color: palette.deepBlue, fontWeight: "800" },
  smallDarkBtn: { flex: 1, borderRadius: 10, backgroundColor: palette.deepBlue, alignItems: "center", paddingVertical: 9 },
  smallDarkText: { color: palette.white, fontWeight: "800" },
  card: { borderRadius: 16, borderColor: palette.line, borderWidth: 1, backgroundColor: palette.white, padding: 12, marginBottom: 14 },
  cardTitle: { textAlign: "right", color: palette.text, fontWeight: "900", marginBottom: 6 },
  ...
  profileInput: { borderWidth: 1, borderColor: palette.line, borderRadius: 12, backgroundColor: "#f8fbfe", paddingHorizontal: 12, paddingVertical: 10, color: palette.text },
  multilineInput: { minHeight: 72, textAlignVertical: "top" },
  fullPrimaryBtn: { marginTop: 8, backgroundColor: palette.deepBlue, borderRadius: 12, alignItems: "center", justifyContent: "center", paddingVertical: 12 },
  fullPrimaryBtnText: { color: palette.white, fontWeight: "900" },
  bookingRow: { borderBottomWidth: 1, borderColor: palette.line, paddingBottom: 12, marginBottom: 12 },
  ...
  bookingInput: { flex: 1, borderWidth: 1, borderColor: palette.line, borderRadius: 10, backgroundColor: "#f8fbfe", paddingVertical: 9, paddingHorizontal: 8, color: palette.text },
  ownerSlotList: { gap: 8, paddingVertical: 10 },
  ownerSlotChip: { borderWidth: 1, borderColor: palette.line, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7, backgroundColor: "#f8fbfe" },
  ...
  acceptBtn: { flex: 1, backgroundColor: "#168a4a", borderRadius: 10, paddingVertical: 10, alignItems: "center" },
  rejectBtn: { flex: 1, backgroundColor: "#c24135", borderRadius: 10, paddingVertical: 10, alignItems: "center" },
  editBtn: { flex: 1, backgroundColor: palette.deepBlue, borderRadius: 10, paddingVertical: 10, alignItems: "center" },
  ...
  miniStat: { flex: 1, borderRadius: 12, borderWidth: 1, borderColor: palette.line, backgroundColor: palette.white, padding: 10 },
  ...
  packageIcon: { width: "48%", borderRadius: 14, borderWidth: 1, borderColor: palette.line, backgroundColor: palette.white, padding: 12, alignItems: "center" },
